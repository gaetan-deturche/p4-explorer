//! Depot-browse helpers: shared cache types and the depot→local path mapping used
//! to show synced contents from disk instantly. All pure — the client name and
//! workspace roots are passed in, so this has no reactive state. Folder-contents
//! and history are written/read by browse/history straight through the store.
