...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::p4_client_spec,
            commands::p4_client_save,
            commands::p4_client_delete,
            commands::p4_client_rename,
            commands::p4_users,
            commands::swarm_reviews,
            commands::swarm_review_detail,
            commands::swarm_comments,
            commands::swarm_add_comment,
            commands::swarm_edit_comment,
            commands::swarm_task_transitions,
            commands::comments_notify_immediately,
            commands::swarm_transitions,
            commands::swarm_set_state,
            commands::review_version_files,
            commands::diff_pair_versions,
            commands::open_review_window,
            commands::review_job,
            ...
            commands::stash_save,
            commands::stash_list,
            commands::stash_patch_file,
            commands::stash_patch,
            commands::stash_delete,
